...
<body>
    ...
    <main class="main_black">
        ...
        <section class="efecto_parallax py-5">
            <div class="container">
                <div class="row fondo_parallax align-items-end">
                    <div class="col-lg-4 encima_fondo">
                        <div class="fondo_opaco">
                            <img src="assets/img/icon_parallax.png" class="img-fluid" alt="">
        ...
        <section class="cto py-5">
            <div class="container">
                <div class="row justify-content-md-center">
                    <div class="col-lg-10">
                        <div class="cto_fondo row align-items-center">
                            <div class="col-lg-6">
                                <div class=""><img src="assets/img/celular.png" class="img-fluid" alt=""></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="texto_cto">
                                    ...
                                    <div class="flex_button_cto">
                                        <div class="texto_informativo">
                                            <p><span>Más de 50 negocios</span> ya gestionan sus <br> procesos con nuestras soluciones. ¿Y tú?</p>
                                        </div>
                                        <div class="a_link">
                                            <a href="">¡Contáctanos Ya!</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="clientes py-5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="carrusel_clientes py-5">
                        <div class="owl-carousel owl-clientes">
                            <div class="item_cliente">
                                <div class="alto_card">
                                    ...
                                    <div class="aparece">
                                        <p>Product Design (UX/UI) | Research | <br> Strategy | User Testing</p>
                                    </div>
                                </div>
                                <div>
                                    <h5>HULLKA COFFE</h5>
                            ...
                            <div class="item_cliente">
                                <div class="alto_card">
                                    <img src="assets/img/logo-astur.png" alt="">
                            ...
                            <div class="item_cliente">
                                <div class="alto_card">
                                    <img src="assets/img/logo-aprak.png" alt="">
